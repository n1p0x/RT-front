...
import { useAddGiftGame } from '@/pages/MyGiftsPage/hooks/useAddGiftGame'
...
export const Gift: FC<Props> = ({
	...
	const { addGiftGame, isPending, isSuccess, isError } = useAddGiftGame(
		userId,
		initData
	)

	const onClick = () => {
		addGiftGame({ userGiftId: id })
	}
